...
public class FacetRequestColumnModelTest {
	...
	////////////////////////////////////////////////
	// appendFacetColumnNameToStringBuilder() tests
	////////////////////////////////////////////////

	@Test
	public void testAppendFacetColumnNameToStringBuilder(){
		String columnName = "facetValues";
		facetValues.setColumnName(columnName);
		String expectedResult = "\"facetValues\"";
		FacetRequestColumnModel.appendFacetColumnNameToStringBuilder(stringBuilder, facetValues);
		assertEquals(expectedResult, stringBuilder.toString());
	}


	@Test
	public void testAppendFacetColumnNameToStringBuilderEscapeSDoubleQuotes() {
		String columnName = "\"You can't believe everything you read on the internet.\" ~Abe Lincoln, 1868";
		facetRange.setColumnName(columnName);
		String expectedResult = "\"\"\"You can't believe everything you read on the internet.\"\" ~Abe Lincoln, 1868\"";
		FacetRequestColumnModel.appendFacetColumnNameToStringBuilder(stringBuilder, facetRange);
		assertEquals(expectedResult, stringBuilder.toString());
	}
}
