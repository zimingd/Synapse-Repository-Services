...
public class TableConstants {
	...
	public final static String ENTITY_REPLICATION_INSERT = "INSERT INTO "+ENTITY_REPLICATION_TABLE+" ("
			...
			+ ENTITY_REPLICATION_COL_IN_SYNAPSE_STORAGE
			+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static final String ANNOTATION_REPLICATION_COL_LIST_VALUE		="LIST_VALUE";
	...
	public static final String ANNOTATION_REPLICATION_TABLE_CREATE = 
			...
			+ ANNOTATION_REPLICATION_COL_LIST_VALUE+" JSON DEFAULT NULL,"
